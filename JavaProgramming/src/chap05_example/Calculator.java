...
public class Calculator {
    ...
    //사용자가 입력한 값(정수1, 정수2)로 사칙연산하는 메소드 4개
    public int add() {
    	return num1 + num2;
    }
    ...
    public void calc() {
        ...
        case "+" :
     	   ...
     	   break;
        case "-" :
        	//op = "-"면 더한 결과를 출력하기 위해 minus메소드 호출
     	   System.out.println((num1 + " " + op + " " + num2 + " = " + minus()));
     	   break;
        case "*" :
        	//op = "*"면 더한 결과를 출력하기 위해 multiple메소드 호출
     	   System.out.println((num1 + " " + op + " " + num2 + " = " + multiple()));
     	   break;
        case "/" :
        	//op = "/"면 더한 결과를 출력하기 위해 divide메소드 호출
