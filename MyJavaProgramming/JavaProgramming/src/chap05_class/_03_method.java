...
public class _03_method {
	...
	public static void main(String[] args) {
	    ...
	    int minusResult = System.out.println("3 - 1 : " + minusResult);
	    ...
	    divide(300, 3, 10);
	    System.out.println("300 / 3 / 10 : " + divid(300, 3, 10));
	}
	...
	public static int minus(int z, int x) {
		return z - x;
	}
	...
	//void(매개변수 3개))
	public static long multiple(long c, long d) {
		return c + d;
		}
